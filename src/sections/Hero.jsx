...
const Hero = () => {
  return (
    <section id="about" className="flex max-md:flex-col gap-20 justify-center items-center min-h-screen  font-Inter ">
      ...
      <div className=" bg-gray-100 rounded-md mt-8 px-8 py-8 ">
        <p className="font-medium text-lg mt-4  text-gray-600 ">As a <span className="font-bold">Junior Front-End Developer</span>, I am passionate about creating visually with Notion
